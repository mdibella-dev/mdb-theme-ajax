...
add_action( 'wp_ajax_vortragsliste', array( 'AJAX_LoadMore_Vortragsliste', 'handle_AJAX' ) );
add_action( 'wp_ajax_nopriv_vortragsliste', array( 'AJAX_LoadMore_Vortragsliste', 'handle_AJAX' ) );
