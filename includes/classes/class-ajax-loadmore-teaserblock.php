...
add_action( 'wp_ajax_teaserblock', array( 'AJAX_LoadMore_Teaserblock', 'handle_AJAX' ) );
add_action( 'wp_ajax_nopriv_teaserblock', array( 'AJAX_LoadMore_Teaserblock', 'handle_AJAX' ) );
